...
import { isActive } from "../redux/sidebarSlice";
  ...
  return (
    <header className=" px-4 w-full h-14 sticky top-0 flex items-center bg-gray-50 shadow-md">
      <div className=" w-full flex justify-between items-center">
        <Link to="/">
          <div className="flex">
            <span className="text-[33px] text-orange-600">
              {/* <AiOutlineBug /> */}
            </span>
            <span className="font-semibold text-2xl hidden sm:block">
              Store<span className="text-orange-700">DECOR</span>
            </span>
          </div>
        </Link>
        ...
        <button
          onClick={openSidebar}
          type="button"
          className={`inline-flex items-center p-1 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none ring-2 ring-gray-300 focus:ring-orange-600 ${
