...
function Home() {
  ...
  return (
    <div className="w-full h-full text-black">
      ...
      <div className="h-full py-10 px-36 w-full bg-orange-50">
        <h1 className="text-6xl text-black ">Our Categories</h1>
        ...
        <div className="flex flex-wrap justify-center items-center gap-5 py-10  mt-5">
          <a
            ...
            className="flex flex-col justify-center items-start gap-3 w-72 h-96 px-4 py-6  bg-white hover:bg-gray-200 duration-200 rounded-lg"
          >
            <img
              className="bg-cover bg-center w-full h-3/4 rounded-lg"
          ...
          <a
            href="/categories/Jar Candles"
            className="flex flex-col justify-center items-start gap-3 w-72 h-96 px-4 py-6  bg-white hover:bg-gray-300 duration-200 rounded-lg"
          >
            <img
              className="bg-cover bg-center w-full h-3/4 rounded-lg"
              src="../../public/candle2.jpg"
      ...
      <div className="h-full py-5 px-36 bg-orange-50">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6">
            ...
            <button
              ...
              className={`duration-200 rounded-full text-xl uppercase ${
                !isMostPopularActive ? "bg-gray-200" : "bg-orange-500"
        ...
        <div className="relative max-w-max overflow-x-hidden">
          ...
          <div
            ref={scrollRef}
            className="flex space-x-4 py-5 px-3"
            ...
            {isMostPopularActive &&
              Array(16)
                ...
                .map((_, index) => (
                  <div
                    key={index}
                    className="flex-shrink-0 sm:w-48 md:w-56 lg:w-72 px-5 py-5 bg-white rounded-lg shadow-lg hover:bg-gray-100 transition duration-300"
                  >
                    <img
          ...
          <div className="lg:flex px-5">
            <div className="lg:w-1/2   flex justify-center gap-5 items-center">
              <img
                ...
                className="w-full  h-96 object-cover transform transition-transform duration-300"
              />
            </div>
            <div className="lg:w-1/2 p-4">
              ...
              <div className="flex items-center mb-4">
                <span className="text-gray-500 line-through mr-2">
                  Rs. {bestSellerProduct.originalPrice.toFixed(2)}
                </span>
                <span className="text-2xl text-red-600 font-bold">
                  Rs. {bestSellerProduct.salePrice.toFixed(2)}
                </span>
