...
import { faUser, faSearch, faBagShopping, faChevronDown } from '@fortawesome/free-solid-svg-icons'
            ...
            <ul className='flex flex-wrap gap-5 justify-center items-center relative'>
                <li>
                    <NavLink 
                        to={"/"}
                        className={({isActive}) =>
                            `block duration-200 hover:text-red-500 ${isActive ? "text-red-500" : "text-gray-500"} ${isActive ? "border-b border-red-500" : "border-b border-gray-300"} `
                        }
                    >
                        Home
                    </NavLink>
            ...
            <ul className='flex flex-wrap justify-center items-center gap-5'>
                ...
                <li>
                    <NavLink
                        to={"/profile"}
                        className={({isActive}) =>
                            `block duration-200 hover:text-red-500 ${isActive ? "text-red-500" : "text-gray-500"} `
                        }
                    >
