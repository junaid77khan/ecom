    ...
    fetchProductsData(state, action) {
        try {
            const fetchProducts = async() => {
                let response = await fetch(`https://ecom-server-we11.onrender.com/api/v1/product/all-products`, {
                  method: 'GET',
                  headers: {
...
export const {fetchProductsData, fetchBestSellerProduct} = productSlice.actions
